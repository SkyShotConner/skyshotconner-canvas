...
admin = admin.replace("[showNew,setShowNew]=useState(false),[newProduct,setNewProduct]=useState({name:'',slug:'',short_description:'',description:'',price:99.99,orientation:'landscape' as 'portrait'|'landscape',limited_edition:false})", "[showNew,setShowNew]=useState(false),[newProduct,setNewProduct]=useState({name:'',slug:'',short_description:'',description:'',price:99.99,category_id:CATEGORIES[0].id,orientation:'landscape' as 'portrait'|'landscape',limited_edition:false})")
...
admin = admin.replace("setNewProduct({name:'',slug:'',short_description:'',description:'',price:99.99,orientation:'landscape',limited_edition:false})", "setNewProduct({name:'',slug:'',short_description:'',description:'',price:99.99,category_id:CATEGORIES[0].id,orientation:'landscape',limited_edition:false})")
