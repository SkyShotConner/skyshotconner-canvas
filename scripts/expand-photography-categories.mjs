...
admin = admin.replace("setNewProduct({name:'',slug:'',short_description:'',description:'',price:99.99,orientation:'landscape',limited_edition:false})", "setNewProduct({name:'',slug:'',short_description:'',description:'',price:349,category_id:CATEGORIES[0].id,orientation:'landscape',limited_edition:false})")
