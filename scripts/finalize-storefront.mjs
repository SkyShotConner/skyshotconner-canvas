...
// The homepage must render immediately; custom site images are optional enhancements.
...
// Fix the malformed Home function produced by the previous finalizer version.
...
// Keep custom site images available without blocking the initial render.
...
if(/siteImages=\{siteImages\}/.test(s) && !/supabase\.from\('site_images'\)/.test(s)){
